...
- [dgis-simulation/README.md](dgis-simulation/README.md) — Simulation architecture, biome details, core scripts reference, database schema
- [dgis-ml-models/README.md](dgis-ml-models/README.md) — Training pipeline, datasets, export formats, evaluation results
- [dgis-mobile/README.md](dgis-mobile/README.md) — Android app features, model requirements, USB serial protocol
- [dgis-iot/README.md](dgis-iot/README.md) — MQTT topics, joint map, gait commands, CAD assemblies, control station tabs
- [dgis-analysis-dashboard/README.md](dgis-analysis-dashboard/README.md) — Dashboard setup, biome database mapping, API endpoints
